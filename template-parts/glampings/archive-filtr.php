...
<div class="glampings-filtr-items">
    ...
    <div class="filtr-item sorting" title="Сортировка">
        <div class="filtr-item__title sort-glemp js-filtr-title">
            <div class="filtr-item__title__text">Сортировка</div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path d="M4.251 181.1C7.392 177.7 11.69 175.1 16 175.1c3.891 0 7.781 1.406 10.86 4.25l197.1 181.1l197.1-181.1c6.5-6 16.64-5.625 22.61 .9062c6 6.5 5.594 16.59-.8906 22.59l-208 192c-6.156 5.688-15.56 5.688-21.72 0l-208-192C-1.343 197.7-1.749 187.6 4.251 181.1z"/>
            </svg>
        </div>
        <div class="filtr-item__value"><?php echo filtr_cookie_value()['title']; ?></div>
    ...
    <div class="filtr-item region">
        ...
        <ul class="filtr-item__options item-options-checkbox custom-scroll my-scrollbar select active">
            <li>
    ...
    <div class="filtr-item price">
        <div class="filtr-item__title price-title">
    ...
    <div class="filtr-item stocks">
        <div class="filtr-item__title">
            <ul class="filtr-item__options item-options-checkbox one">
                <li>
                    <input type="checkbox" id="stocks" name="stocks" data-name="glcStocks" value="1">
                    <label for="stocks">
                        <span class="checkmark fcheckbox">
                            <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <path d="M438.6 105.4C451.1 117.9 451.1 138.1 438.6 150.6L182.6 406.6C170.1 419.1 149.9 419.1 137.4 406.6L9.372 278.6C-3.124 266.1-3.124 245.9 9.372 233.4C21.87 220.9 42.13 220.9 54.63 233.4L159.1 338.7L393.4 105.4C405.9 92.88 426.1 92.88 438.6 105.4H438.6z"></path>
                        ...
                        <span class="name">Только с акциями</span>
    ...
    <div class="filtr-item recommended">
        <div class="filtr-item__title">
            <ul class="filtr-item__options item-options-checkbox one">
                <li>
                    <input type="checkbox" id="glamping_recommended" name="recommended" data-name="glcRecom" value="">
                    <label for="glamping_recommended">
                        <span class="checkmark fcheckbox">
                            <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <path d="M438.6 105.4C451.1 117.9 451.1 138.1 438.6 150.6L182.6 406.6C170.1 419.1 149.9 419.1 137.4 406.6L9.372 278.6C-3.124 266.1-3.124 245.9 9.372 233.4C21.87 220.9 42.13 220.9 54.63 233.4L159.1 338.7L393.4 105.4C405.9 92.88 426.1 92.88 438.6 105.4H438.6z"></path>
                            </svg>
                        </span>
                        <span class="name">Рекомендованные</span>
                        <span class="count">0</span>
                    </label>
                </li>
            </ul>
    ...
    <div class="filtr-item allocation">
        ...
        <ul class="filtr-item__options item-options-checkbox custom-scroll my-scrollbar select">
