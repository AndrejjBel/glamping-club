        ...
        <div class="single-section description">
            ...
            <?php if ($count_content_symbol > 400) {?>
                <div class="collapse-content-btn js-btn-descr">
                    ...
                    <!-- <svg width="15" height="7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
// $media_gallery = get_post_meta( 181, 'photos', 1 );
// $name = glamping_review_img_list(181);
// echo count($media_gallery);
// echo '<pre>';
// var_dump($media_gallery);
// echo '<pre>';
