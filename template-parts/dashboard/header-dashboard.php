<header id="dashboard-header" class="site__header dashboard">
    <div class="container-dashboard">
        <div class="header-generale">
            <div class="header-generale__left dashboard">
                <button id="js-sidebar-nav-dashboard" type="button" name="button" class="header-generale__left__slider-btn dashboard">
            ...
            <div class="header-generale__right dashboard">
            ...
            <?php glamping_club_user_dname(0); ?>
        </div>
    </div>
</header><!-- #masthead -->
