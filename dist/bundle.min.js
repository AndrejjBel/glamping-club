...
addFavCom();
var deleteFavCom = function deleteFavCom() {
  var favoritesBtns = document.querySelectorAll('#delete-favorites');
  var comparisonBtns = document.querySelectorAll('#delete-comparison');
  if (favoritesBtns.length) {
    var supFavorites = document.querySelectorAll('#sup-favorites');
    favoritesBtns.forEach(function (btn) {
      btn.addEventListener('click', function (e) {
