  ...
  filtrItems.addEventListener('click', function (event) {
    ...
    if (input) {
      ...
      if (input.dataset.name != 'glcRegion') {
        if (localStorage.getItem('glcType') || localStorage.getItem('glcAllocation') || localStorage.getItem('glcWorking') || localStorage.getItem('glcNature') || localStorage.getItem('glcFacilGen') || localStorage.getItem('glcEntertainment') || localStorage.getItem('glcTerritory') || localStorage.getItem('glcSafety') || localStorage.getItem('glcPrice')) {
          locationsArchive(newgGempAll);
        } else {
          locationsArchive(glempAll);
        }
